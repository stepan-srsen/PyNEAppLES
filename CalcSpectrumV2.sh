...
gauss=0		# Gaussian broadening standard deviation in eV, 0 for automatic setting, negative value to turn off
...
decompose=false	# Turns on/off decomposition of the spectrum into participating excited states (adds one column per each state to the output file)
